...
$sql = utf8_decode("select login FROM usuarios where login='".$_SESSION['vusuario']."' and  clave='".$_SESSION['vclave']."'");
//echo $sql;
...
<!--  <form id="mes" name="mes" action="Ingreso_usuario_remision.php" method="post"> -->
  <form id="mes" name="mes" action="Covid_Actualiza_lote.php" method="post" autocomplete="off">  


<p><strong>Lote Covid</strong>:
