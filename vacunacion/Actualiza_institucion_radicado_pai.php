...
$query_Recordset1 = utf8_decode ("SELECT Nombre_institucion FROM institucion WHERE Nombre_institucion='".$_POST["Institucion"]."'");
...
<?php
	include "Actualiza_institucion_radicado_pai2.php";
