...
<script language="javascript" type="application/javascript">
	...
	function ok()
	{
		...
		{
			alerta(document.getElementById('Nombre_institucion'));
					return false;
		}
...
$editFormAction = $_SERVER['PHP_SELF'];
 $editFormAction = "Covid_Ingreso_exitoso_institucion.php";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off">
   <P>
  <div align="center"><strong>INGRESO INSTITUCION COVID</strong></div>
 
  <table align="center">
   
    <tr valign="baseline">
     <td nowrap="nowrap" align="right"><div align="left"><strong><p style="color:#FF0000";>CODIGO DE HABILITACION:</strong></div></td>
      <td><input type="text" name="Codigo_habilitacion" id="Codigo_habilitacion" value="" size="50" style="text-transform:uppercase" onKeyUp="javascript:this.value=this.value.toUpperCase();" title="Codigo_habilitacion"/> 
    </tr>
   
   
   
    <tr valign="baseline">
     <td nowrap="nowrap" align="right"><div align="left"><strong><p style="color:#FF0000";>NOMBRE DE LA INSTITUCION:</strong></div></td>
      <td><input type="text" name="Nombre_institucion" id="Nombre_institucion" value="" size="50" style="text-transform:uppercase" onKeyUp="javascript:this.value=this.value.toUpperCase();" title="Nombre_institucion"/> 
    </tr>
   
   
   <tr valign="baseline">
       <td width="188" align="right" nowrap="nowrap"><div align="left"><strong><p style="color:#FF0000";>ESTADO:</strong></div></td>
      <td width="208"><select name="Estado" title=<?php echo ('"Estado"') ?> id="Estado" value="<?php echo $row_Recordset1['Estado'];?>" />
...
$query_Recordset1 = "SELECT * FROM institucion_covid";
...
<table border="1" align="center">
  ...
  <tr>
  <td><center><B>CODIGO HABILITACION</td>
   <td><center><B>NOMBRE DE INSTITUCION</td>
...
<!-- <a href="javascript:enviar(<?php echo $row_Recordset1['Id']; ?>)"> <?php echo $row_Recordset1['Id']; ?>&nbsp; </a>  -->
     ...
     <td><?php echo ($row_Recordset1['Codigo_habilitacion']); ?>&nbsp; </td>
      <td><?php echo ($row_Recordset1['Nombre_institucion']); ?>&nbsp; </td>
