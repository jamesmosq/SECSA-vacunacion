...
<center><b>ENTREGA DE INSUMOS PAI </b></center>
...
$condicion="l.insumo ='".$_POST["txt_nombre"]."' AND ". "l.Lote = m.Lote" ."   AND ". "m.Nro_pedido = p.Nro_pedido" ." ORDER BY m.Id asc";
...
<!-----	
	...
	{ 
		?>
        <tr>
     <td><?php echo utf8_encode($linea['Id']);?></td>
     <td><?php echo utf8_encode($linea['Institucion']);?></td>
	 <td><?php echo utf8_encode($linea['Nro_pedido']);?></td>
	 <td><?php echo utf8_encode($linea['Fecha_movimiento']);?></td>
	 <td><?php echo utf8_encode($linea['Lote']);?></td>
	 <td><?php echo utf8_encode($linea['Insumo']);?></td>
	 <td><?php echo utf8_encode($linea['Ingreso']);?></td>
	 <td><?php echo utf8_encode($linea['Salida']);?></td>
	<!-- <td><?php echo utf8_encode($linea['Observaciones']);?></td> -->
	 <td><?php echo utf8_encode($linea['Tipo_identificacion']);?></td>
	 <td><?php echo utf8_encode($linea['Identificacion']);?></td>
	 <td><?php echo utf8_encode($linea['Nombres_apellidos']);?></td>
