...
<center><b>INFORME DE APLICATIVOS</b></center>


<!----------------------  -->
 <form name="fini" action="Insumo_1.php" method="post">
...
$db_selected = mysqli_select_db($vacunacion, $database_vacunacion);
	  ...
	  $consulta= "SELECT Nombre FROM Insumo";
			  
  ?>
 <p><strong><p style="color:#FF0000";>Insumo:</strong>
<select input type="text" name="txt_nombre" id="txt_nombre" value="" title="txt_nombre" required>
        <option value="Nombre_institucion LIKE '%'"></option>
          <?php
			  ...
			  { 
		 	echo "<option value=\"".utf8_encode($linea[0])."\">".utf8_encode($linea[0])."</option>\n";
              } 
