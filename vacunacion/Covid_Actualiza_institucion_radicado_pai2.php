...
FROM movimiento_covid m, tbl_lote_covid l, pedido_covid p  where m.Institucion='".$_SESSION['Institucion']."' and m.lote = l.lote and m.Nro_pedido = p.Nro_pedido order by Id desc");
...
<form id="forma1" name="forma1" method="POST" action="Covid_Actualiza_radicado_pai.php">
...
<!--<?php echo $row_Recordset1['Id']; ?>&nbsp; </a> -->
    ...
    <!-- <td><?php echo ($row_Recordset1['Institucion']); ?>&nbsp; </td> -->
