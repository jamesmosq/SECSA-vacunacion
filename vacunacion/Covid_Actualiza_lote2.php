...
if (!Empty($_POST['Lote'])) $_SESSION["Lote"] = $_POST['Lote'];

//ECHO "<br> NUMERO DE IDENTIFICACION:".$_SESSION["Identificacion"]
...
$query_Recordset1 = ("SELECT * FROM tbl_lote_covid where Lote='".$_SESSION['Lote']."'");
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysqli_query($vacunacion, $query_limit_Recordset1) or die(mysql_error());
$row_Recordset1 = mysqli_fetch_assoc($Recordset1);

if (isset($_GET['totalRows_Recordset1'])) {
  $totalRows_Recordset1 = $_GET['totalRows_Recordset1'];
} else {
  $all_Recordset1 = mysqli_query($vacunacion,$query_Recordset1);
