...
$editFormAction = $_SERVER['PHP_SELF'];
 $editFormAction = "Covid_Ingreso_exitoso_laboratorio.php";
...
<title>INGRESO LABORATORIO</title>
</head>
<body>
<p>&nbsp;</p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off">
   <P>
  <div align="center"><strong>INGRESO LABORATORIO</strong></div>
  ...
  <table align="center">
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right"><div align="left"><strong><p style="color:#FF0000";>NOMBRE DEL LABORATORIO:</strong></div></td>
...
$query_Recordset1 = "SELECT * FROM laboratorio_covid";
...
<table border="1" align="center">
  ...
  <tr> 
   <td><center><B>NOMBRE DEL LABORATORIO</td>    	
   </tr>
  <?php do { ?>
    <tr>
