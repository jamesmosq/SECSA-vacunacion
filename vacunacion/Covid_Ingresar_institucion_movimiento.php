...
<!--  <form id="mes" name="mes" action="Ingreso_usuario_remision.php" method="post"> -->
  <form id="mes" name="mes" action="Covid_Actualiza_institucion_movimiento.php" method="post">  

<?php
	  $consulta= "SELECT Nombre_institucion FROM institucion_covid where Estado='Activo' order by Nombre_institucion asc";
  ?>
<strong><p style="color:#FF0000";>Nombre de instituci&oacuten:</strong>
