...
<!----------------------  -->
 <form name="fini" action="Institucion_pedido_1.php" method="post">
...
$db_selected = mysqli_select_db($vacunacion, $database_vacunacion);
	  ...
	  $consulta= "SELECT Nombre_institucion FROM institucion";
...
<select input type="text" name="txt_nombre" id="txt_nombre" value="" title="txt_nombre" required>
	...
	<p><strong><p style="color:#FF0000";>PEDIDO:</strong>
  <input type="Int" name="txt_pedido" id="txt_pedido" size="10" title="txt_pedido" required>
</p>
