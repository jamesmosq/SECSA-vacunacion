...
$condicion="m.institucion ='".$_POST["txt_nombre"]."' and "." m.Fecha_movimiento='".$_POST["txt_fecha"]."' AND ". "l.Lote = m.Lote" ."   AND ". "m.Nro_pedido = p.Nro_pedido" ." ORDER BY m.Id asc";
...
//echo $condicion;
	...
	$sql = "SELECT m.Id, m.Institucion, m.Fecha_movimiento, m.Lote, m.Ingreso, m.Salida, m.Tipo_identificacion, m.Identificacion, m.Nombres_apellidos, m.Nro_pedido, l.Insumo, p.Observaciones, p.Temperatura, l.Fecha_vencimiento 
