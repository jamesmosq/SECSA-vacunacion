...
<center><b>MOVIMIENTO INSUMOS COVID POR PERIODO</b></center>
...
$condicion="m.Fecha_movimiento >='".$_POST["txt_fecha_inicial"]."' and "." m.Fecha_movimiento <='".$_POST["txt_fecha_final"]."' AND ". "l.Lote = m.Lote" ."   AND ". "m.Nro_pedido = p.Nro_pedido" ." ORDER BY m.Id asc";
