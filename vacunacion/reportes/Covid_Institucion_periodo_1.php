...
<center><b>INSUMOS COVID </b></center>
...
$condicion="m.institucion ='".$_POST["txt_nombre"]."' and "." m.Fecha_movimiento >='".$_POST["txt_fecha_inicial"]."' and "." m.Fecha_movimiento <='".$_POST["txt_fecha_final"]."' AND ". "l.Lote = m.Lote" ."   AND ". "m.Nro_pedido = p.Nro_pedido" ." ORDER BY m.Id asc";
...
//echo $condicion;
	...
	$sql = "SELECT m.Id, m.Institucion, m.Fecha_movimiento, m.Lote, m.Ingreso, m.Salida, m.Tipo_identificacion, m.Identificacion, m.Nombres_apellidos, m.Nro_pedido, l.Insumo, p.Observaciones, p.Temperatura 
...
<!-----	
   ...
   <!--  <td><?php echo ($linea['Institucion']);?></td> -->
	 ...
	 <td><?php echo ($linea['Temperatura']);?></td>
