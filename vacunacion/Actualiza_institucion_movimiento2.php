...
require_once('Connections/vacunacion.php');
$db_selected = mysqli_select_db($vacunacion, $database_vacunacion);
$query_Recordset1 = mysqli_query($vacunacion, "SELECT * FROM movimiento, tbl_lote where Institucion='".$_SESSION['Institucion']."' and movimiento.lote = tbl_lote.lote order by Id desc");
...
<table border="1" align="center">
  <tr>
				<td colspan="11"><center>MOVIMIENTO DE INSUMOS</center></td>
...
$query_Recordset1 = "SELECT * FROM movimiento where institucion='".$_SESSION['Institucion']."'";
