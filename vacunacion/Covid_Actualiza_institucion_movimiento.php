...
$query_Recordset1 = utf8_decode ("SELECT Nombre_institucion FROM institucion_covid WHERE Nombre_institucion='".$_POST["Institucion"]."'");
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
   <P>
   <div align="center"><strong>DATOS DE LA INSTITUCION</strong></div>
...
<?php
	include "Covid_Actualiza_institucion_movimiento2.php";
