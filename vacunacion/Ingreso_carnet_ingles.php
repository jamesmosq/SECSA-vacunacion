...
$editFormAction = $_SERVER['PHP_SELF'];
 $editFormAction = "Ingreso_exitoso_carnet_ingles.php";
...
-->
    ...
    <tr valign="baseline">
      ...
      <td width="208"><select name="Tipo_id" title=<?php echo ('"Tipo_id"') ?> id="Tipo_id" value="<?php echo ($row_Recordset1['Tipo_id']);?>" />
...
<form id="forma1" name="forma1" method="POST" action="Entrega_carnet_ingles.php">
