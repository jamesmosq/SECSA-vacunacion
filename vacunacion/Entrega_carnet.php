...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete = "off">
   ...
   <div align="center"><strong>CERTIFICA</strong></div>
 </BR>
 </BR>
 ...
 Que el señor (a)  <B> <?php echo ($row_Recordset1['Nombres']); ?> </B>
 </p> 
 Identificado(a) con <B> <?php echo ($row_Recordset1['Tipo_id']); ?> </B> número <B><?php echo ($row_Recordset1['Numero_id']); ?></B> de  <B><?php echo ($row_Recordset1['Expedicion_id']); ?></B> 

 no es susceptible de vacunación con los biológicos de Fiebre Amarilla, SR (Sarampión y Rubéola) ya que presenta riesgo elevado de efectos adversos.  

 </P>

Además, el Ministerio de Salud y el laboratorio productor de la vacuna no recomiendan la aplicación a la población mayor de 60 años, mujeres embarazadas o en periodo de lactancia materna. 

</P>
</BR>
Fecha de expedición: <B><?php echo ($row_Recordset1['Fecha']); ?> </B>
