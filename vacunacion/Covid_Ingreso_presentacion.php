...
<script language="javascript" type="application/javascript">
	...
	function ok()
	{
		...
		{
			alerta(document.getElementById('Descripcion'));
					return false;
		}
...
$editFormAction = $_SERVER['PHP_SELF'];
 $editFormAction = "Covid_Ingreso_exitoso_presentacion.php";
...
<title>INGRESO PRESENTACION</title>
</head>
<body>
<p>&nbsp;</p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" autocomplete="off">
   <P>
  <div align="center"><strong>INGRESO PRESENTACION</strong></div>
  ...
  <table align="center">
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right"><div align="left"><strong><p style="color:#FF0000";>PRESENTACION:</strong></div></td>
      <td><input type="text" name="Descripcion" id="Descripcion" value="" size="50" style="text-transform:uppercase" onKeyUp="javascript:this.value=this.value.toUpperCase();" title="Descripcion"/> 
    </tr>
...
$query_Recordset1 = "SELECT * FROM presentacion_covid";
