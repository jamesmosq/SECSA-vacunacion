@extends('layouts.app')
@section('title', 'Informe por Insumo y Periodo')
@section('content')
<h4 class="mb-3">Informe por Insumo y Periodo</h4>
<form method="POST" action="{{ route('reportes.insumo-periodo') }}" class="row g-3 mb-4">
    @csrf
    <div class="col-md-2">
...
@foreach($movimientos as $insumo => $movs)
    ...
    <table class="table table-sm table-bordered">
        <thead class="table-secondary"><tr><th>Fecha</th><th>Institución</th><th>Lote</th><th>Ingreso</th><th>Salida</th></tr></thead>
        <tbody>
            @foreach($movs as $mov)
            <tr>
