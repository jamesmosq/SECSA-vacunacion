...
<form method="POST" action="{{ route('reportes.covid.institucion-periodo') }}" class="row g-3 mb-4">
    @csrf
    <div class="col-md-4">
...
<table class="table table-sm table-bordered">
    <thead class="table-danger"><tr><th>Fecha</th><th>Nro Pedido</th><th>Lote</th><th>Ingreso</th><th>Salida</th><th>Observaciones</th></tr></thead>
    <tbody>
