...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ isset($movimiento) ? route('movimientos.update', $movimiento) : route('movimientos.store') }}" id="form-movimiento">
            @csrf
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                @if(!isset($movimiento))
                <button type="button" class="btn btn-sm btn-outline-primary" id="btn-agregar">+ Agregar insumo</button>
                @endif
            </div>
